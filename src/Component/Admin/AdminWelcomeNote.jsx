...
const [WelcomeNoteId, setWelcomeNoteId] = useState({});
const EditWelcomeNote=async()=>{
  try {
    const config={
...
console.log("EditWelcomeNote",EditWelcomeNote);
    ...
    <div>
      ...
      <div className="customerhead p-2">
        <div className="d-flex justify-content-between align-items-center">
          <h2 className="header-c ">Welcome Note</h2>
        ...
        >
          ...
          <Modal.Body>
            <div className="row">
              <div className="do-sear mt-2">
                <label>Edit Welcome Heading</label>
                <input
                  type="text"
                  className="vi_0"
                  placeholder="Enter Banner Title"
            ...
            <div className="row">
              <div className="do-sear mt-2">
                <label>Edit Welcome Description</label>
                <CKEditor editor={ClassicEditor} onChange={handleChange} />
              </div>
            </div>
...
export default AdminWelcomeNote;
