...
const AdminOnGoingProjectBanner = () => {
     // Ck Editor Code
...
const [onGoingProjectImage, setonGoingProjectImage] = useState('');
const [OnGoingProjectText, setOnGoingProjectText] = useState('');

const AddOnGoingProject= async () => {
  try {
    const config = {
    ...
    if (res.status === 200) {
      ...
      handleClose3();
      getOnGoingProject();
      setonGoingProjectImage("");
      setOnGoingProjectText("");
    }
  } catch (error) {
...
const [onGoingProjectId, setonGoingProjectId] = useState("");

const EditOnGoingProject=async()=>{
try {
  const config={
  ...
  return (
    ...
    <ToastContainer/>
       <div className="customerhead p-2">
            ...
            <h2 className="header-c ">OnGoing Project Banner</h2>
            <div className="d-flex gap-3">
              <button className="admin-add-btn" onClick={handleShow3}>
               Add OnGoing Project Banner
              </button>
            </div>
          ...
          />
            ...
            <Modal show={show3} onHide={handleClose3} style={{ zIndex: "99999" }}>
              <Modal.Header
                closeButton
              >
                <Modal.Title>Add OnGoing Project</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                
              <div className="row">
                  <div className="do-sear mt-2">
                    <label>Add OnGoing Project Image</label>
                    <input
                      type="file"
                      name=""
                      id=""
                      className="vi_0"
                   onChange={(e) => setonGoingProjectImage(e.target.files[0])}
                    />
                  </div>
                </div>
              ...
              <div className="row">
                  <div className="do-sear mt-2">
                    ...
                    onChange={(e) => setOnGoingProjectText(e.target.value)}
                    />
                  </div>
                </div>
            ...
            >
              ...
              <div className="row">
                  <div className="do-sear mt-2">
                    <label>Edit OnGoing Project Image</label>
                    <input
                      type="file"
                      name=""
                      id=""
...
export default AdminOnGoingProjectBanner
